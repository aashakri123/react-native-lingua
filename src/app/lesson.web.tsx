...
export default function LessonScreen() {
  ...
  useEffect(() => {
    ...
    return () => {
      if (!isCompleted.current && posthog && currentLesson) {
  ...
  // Simulate local room connection setup
  useEffect(() => {
    ...
    return (
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.loadingContainer}>
          ...
          <Text style={styles.loadingText}>Connecting to audio classroom (Web)...</Text>
        </View>
      </SafeAreaView>
    );
  }
...
// Inner Component that mimics the call screen without requiring native WebRTC bindings
function LessonCallContent({
  ...
  const sessionStatus = isMicMuted ? "Muted" : "Joined";
      ...
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          ...
          <View style={styles.titleWrapper}>
            <Text style={styles.headerTitle}>AI Teacher (Web)</Text>
